...
class PDFCourtExtractor:
    ...
    def _save_batch_results(self, results: List[Dict[str, Any]], county: str):
        ...
        with open(csv_file, 'w', newline='', encoding='utf-8') as f:
            writer = csv.writer(f)
            writer.writerow(['PDF File', 'County', 'MongoDB Doc ID', 'Incident Date', 'Incident End Date', 'Standard Incident Date', 'Standard Incident End Date', 'Is Incident', 'All Dates Count', 'Multiple Dates', 'Standard Multiple Dates', 'Status'])
